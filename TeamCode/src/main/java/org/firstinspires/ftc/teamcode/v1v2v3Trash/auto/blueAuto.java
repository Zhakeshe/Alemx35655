...
public class blueAuto extends OpMode {
    ...
    private final Pose preDopT = new Pose(42, 87, Math.toRadians(180));
    private final Pose dopT = new Pose(13, 87, Math.toRadians(180));

    private final Pose preDopC = new Pose(44, 65, Math.toRadians(180));
    private final Pose dopC = new Pose(9, 60, Math.toRadians(180));

    private final Pose preOpGate = new Pose(30, 65, Math.toRadians(180));
    private final Pose OpGate = new Pose(14.5, 70, Math.toRadians(180));
    ...
    private final Pose park = new Pose(40, 75, Math.toRadians(90));
