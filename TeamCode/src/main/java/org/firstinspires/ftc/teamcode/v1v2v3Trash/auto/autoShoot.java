...
public class autoShoot {
    ...
    public static double ref1 = 1200;
    ...
    private HighShooterState highShooterState;
    ...
    private double TransCloseTime = 3.0;
    ...
    private int highShotsRemaining = 0;
    private int intakeRemaining = 0;
    private int intakeRemaining1 = 0;


    private double ShootTime = 0.7;
    ...
    public void init(HardwareMap hwMap){
        ...
        highShooterState = HighShooterState.preshoot;
    ...
    public void highShooter(){
        switch (highShooterState){
            case preshoot:
                if (highShotsRemaining > 0){
                    Intake.setPower(1);
                    Trans.setPower(-1);
                    ...
                    highShooterState = HighShooterState.shoot;
                }
                break;
            ...
            case shoot:
                if (stateTimer.seconds() > ShootTime){
                    ...
                    highShooterState = HighShooterState.reset;
                }
                break;
            case reset:
                if (stateTimer.seconds() > TransCloseTime){
    ...
    public void HighShoots(int numberofshots){
        if (highShooterState == HighShooterState.preshoot){
            highShotsRemaining = numberofshots;
        }
    }
    ...
    public boolean highisbusy(){
        return highShooterState != HighShooterState.preshoot;
    }
