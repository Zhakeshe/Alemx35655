...
@Configurable
@Autonomous(name = "ZHORIK AUTO BLUE  ", group = "Digital")
public class AutoBlue extends OpMode {
    ...
    public static double FIRST_SHOT_WARMUP_DELAY    = 0.40;
    public static double FOLLOWUP_SHOT_WARMUP_DELAY = 0.14;
    public static double SHOT_FORCE_OPEN_DELAY      = 0.60;

    public static double TIME_TO_SHOOT = 0.5;

    public static double TUREL_SHOT_1_POSITION = 1.0;
    public static double TUREL_SHOT_2_POSITION = 1.0;
    ...
    // --- Координаты ---
    private final Pose startPose = new Pose(35, 134, Math.toRadians(180));
    private final Pose shootPose = new Pose(47.14653837967532, 83.95496894409939, Math.toRadians(180));

    private final Pose collectPose1        = new Pose(18, 64, Math.toRadians(180));
    private final Pose collectControlPose1 = new Pose(59.689733654534564, 61.55919003115266, Math.toRadians(180));
    private final Pose returnControlPose1  = new Pose(60.571353592229265, 69.71417445482868, Math.toRadians(180));

    private final Pose collectPose2 = new Pose(21, 87, Math.toRadians(180));

    private final Pose gatePose        = new Pose(14, 66.5, Math.toRadians(160));
    private final Pose gateDeepPose    = new Pose(13.181619937694705, 57.58674686077769, Math.toRadians(180));
    private final Pose gateDeepControl = new Pose(27.61411600692353, 58.432072855709556, Math.toRadians(180));

    private final Pose parkPose = new Pose(39.67445482866044, 58.22040498442367, Math.toRadians(180));
