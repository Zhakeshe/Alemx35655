...
public class FinalClips extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        OutKoteru1.setPosition(0);
        OutKoteru2.setPosition(0);
        OutKozgalu.setPosition(0.35);
        OutKoteru3.setPosition(0.7);
    ...
    private void Outtake() {
        ...
        if (gamepad1.y){
            OutKoteru3.setPosition(0.60);
            OutKoteru1.setPosition(0.9);
            OutKoteru2.setPosition(0.9);
            OutKozgalu.setPosition(0.3);
